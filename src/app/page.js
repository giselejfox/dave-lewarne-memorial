    ...
    <div className="container pb-5">
      <Row className="main-row">
        ...
        <Col xs={12} lg={7} className="pt-lg-5">
          ...
          <div>The livestream will commence at 4:30pm(?). After the event we will link out to a recording of the service.</div>
          <button className="btn btn-success mt-3 mb-5 w-fit">Link to the Livestream</button>
          <h2>How to Support</h2>
          <h3>Donations</h3>
          <p>We encourage you to show your love for Dave through championing the kids in your community. Instead of buying flowers or food, we kindly ask that you donate to the Dave LeWarne scholarship.</p>
          <p><a href="https://www.snoed.org/donate-online/">Click here</a> to donate online, include Dave LeWarne in the "Notes/Name of Tribute/Fund/Scholarship" section of the form.</p>
