    ...
    <div className="container pb-5">
      <Row className="main-row">
        ...
        <Col xs={12} lg={8} className="pt-lg-5">
          ...
          <p>We encourage you to show your love for Dave through supporting the students in your community. In lieu of flowers, please consider a donation to the David J. LeWarne Memorial Scholarship.</p>
