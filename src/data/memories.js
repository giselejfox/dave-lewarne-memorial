const memories = [
    {
        name: "Tim Danner",
        message: "Dave was a friend, mentor, and coach. He never missed and opportunity to encourage and uplift everyone around him. Dave was there for me throughout high school and during my mom’s health issues was there for me in so many ways. He supported me after high school through success and failure. He became a a good friend and mentor to me in my young adult life. We will miss you Dave."
    },
    {
        name: "",
        message: "Dave was one of a kind. He had this wonderful ability to make everyone feel welcome and appreciated. Dave was my XC coach at SHS and became a mentor and friend after high school. Dave never lost touch with me and was there for me in some dark times in my early adult life. Dave was always willing to let me try some crazy run at practice and willing to let me run every distance event at one tack meet. I'll never forget when he left Alex Hopkins, myself, and another runner at South Whidbey High School. When we called him he said he knew he'd left us but they were going to be cutting it close to make the ferry. He then said he knew we'd figure out a way home. Long story short we did and made it to bus right before they got on the ferry. Dave never doubted us for one second. An incident that could have got him in trouble but we loved him for it as it gave us the chance to prove ourselves under pressure. Love you Dave. We'll take it from here."
    },
    {
        name: "Ian Kiesel SHS XC",
        message: "When I first joined cross country in 8th grade down at CMS, I considered quitting almost immediately, and I still was even in 9th grade and this year, but LeWarne didn't let me. I'm now a sophomore at SHS and I'm on the cross country and the track team. Being a sophomore I hadn't known LeWarne for that long, but I could tell immediately that he cared so much about everyone around him. Over time I learned so much from LeWarne, but there is one that sticks out to me so much more now than ever before. LeWarne would always be saying that cross country is a team sport, I wish I listened sooner. The reason this came to mind is because when the team lost Alex, LeWarne was the glue holding the team together, and he was always a shoulder to lean on in tough times. I realize now that cross country truly is a team sport, and we need to be there for each other, we need to be that glue for the team. Thank you LeWarne, for everything you've done. Thank you for the endless support, the kindness, the happy mood you brought, the extra push during races, the willingness to always listen, the constant reminders that we can make every day just a little bit better, a little bit easier, no matter what. I can't even express in words how thankful I was to have you as a coach. Thank you so, so, so much, you left a positive impact on everyone you met. Thank you for everything you taught me, you never gave up on any of us, no matter what. You changed my life in such a positive way, thank you for everything, and thank you so much for not letting me quit when I was in a rough spot. I can never thank you enough for everything you've done and every way you helped and changed me for the better. I miss you, so, so, so much, you were always more than a coach, thank you."
    },
    {
        name: "",
        message: "I had the distinct pleasure to know David LeWarne twice in my life — once as student, and then once again as a coworker years later. He taught me Biology, but I’d be lying if I said I still remembered much more than what the Mitochondria does. What I always will remember, though, is the way it felt when he’d warmly welcome me into his classroom each day; the way it felt to have someone in my corner, rooting for me so wholeheartedly; the way his dry humor could always make me laugh, even when I’d roll my eyes at him; and how, like so many others today said, he could make me feel like the most important person in the world. He was a role model for me, and he set an example that I’m still striving to achieve to this day. I know that the impact he had on me, and on our community, will continue long after this day has come and gone. While I hope that you were one of the lucky ones who got to feel it firsthand, I trust that, if you weren’t, you’ll still be fortunate enough to see it and to feel it in the kindness, the humor, and the care of those who will carry on his legacy. Love you, Dave"
    },
    {
        name: "",
        message: "LeWarne became a part of our lives when he became a part of our son's life. Less than a year after he joined the XC team, I knew he was a part of something special. You could feel the positive energy at all of their events and the way the team lifted each other up was amazing to witness. This kind of magic doesn't just happen on its own. He had this ability to bring out the best in every kid at every stage - he met them where they were. I hope that he realized the impact he made. Jeff and I really got to know him these past few years as we became more involved with the team. He truly cared about his athletes and really saw them. I am grateful for his humor, for the care he showed both of my children, and the legacy he leaves."
    },
    {
        name: "Ellie Baxter",
        message: "I’m in my senior year of running cross country and track for Cal Poly, and LeWarne has sent me a text before and after every race I’ve run in my college career, sometimes even a good luck bitmoji! LeWarne-Thank you for teaching me how to be tough, how to be a good teammate, and how to fall in love with running and its people. We miss you❤️"
    },
    {
